...
subroutineOne:
  ...
  call	sprintLF	; call our string printing with linefeed
...
.finished:
  ...
  mov	eax, 1		; move the value one into eax (for subroutine one)
...
subroutineTwo:
  ...
  jmp	.finished	; jump to the local label under the subroutineTwo scope

.finished:
  mov	eax, msg2	; move the address of msg2 into eax
  call	sprint		; call our string printing with linefeed function
  mov	eax, 2		; move the value two into eax (for subroutine number 2)
  call	iprintLF	; call our integer printing function with linefeed function
